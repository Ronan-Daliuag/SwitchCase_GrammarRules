...
public class SwitchCaseValidation {
    ...
    public static void main(String[] args) {
        ...
        //
        // if (forCheck.toLowerCase().equals("switch(")) { //I think kailangan tanggalin
        // yung .toLowerCase() since I think explicit the small cases yung term na
        // "switch"
        ...
        // for (int i = pointer; i < input.length(); i++) {
        //
        // if (input.charAt(i) == 'c' && input.charAt(i + 1) == 'a' && input.charAt(i +
        // 2) == 's'
        // && input.charAt(i + 3) == 'e') {
        ...
        // 0 && input.charAt(i) <= 9) && (input.charAt(i+1) == ':')) {
